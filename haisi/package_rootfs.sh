...
#1
if [ ! -d out/board_tools/e2fsprogs ] || [ ! -d out/board_tools/hifat] || [ ! -d out/board_tools/mtd-utils ] || [ ! -d out/board_tools/parted ] || [ ! -d out/board_tools/reg_tool ] || [ ! -d out/board_tools/udev ]; then
