...
subdirs += $(MTK_PATH_PLATFORM)/hardware/m4u
subdirs += $(TOPDIR)frameworks/native/libs/utils
subdirs += $(MTK_PATH_SOURCE)protect-bsp/platform/mt6582/hardware/dpframework
...
##Gionee: xuwen 20110602 added for resolving packages link issue begin
packages_attr := $(shell if [ -h packages ]; then echo 'link'; else echo 'dir'; fi )
ifeq ($(packages_attr),link)
subdirs += ./packages
endif
##Gionee: xuwen 20110602 added end
FULL_BUILD := true
...
##Gionee: xuwen 20110602 modified to ignore svn file begin
#subdir_makefiles := \
#	$(shell build/tools/findleaves.py --prune=out --prune=.repo --prune=.git $(subdirs) Android.mk)
#$(error $(subdirs))
subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=out --prune=.repo --prune=.git --prune=.svn --prune=gionee $(subdirs) Android.mk)
##Gionee: xuwen 20110602 modified end
...
#Gionee Qux, spdata image
droidcore: $(INSTALLED_SPDATAIMAGE_TARGET)
