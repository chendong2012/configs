...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("0"), 
            ITEM_AS_USER_LIST_(
//Gionee <zhangwu><modify> for CR00824848 begin
#if ORIGINAL_VERSION
                ...
                "1.0",      //exposure compensation step; EV = step x index
#endif
//Gionee <zhangwu><modify> for CR00824848 end
            )
        ), 
    )
#endif
...
FTABLE_SCENE_DEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
// Gionee wutangzhi 2013-01-10 modify for CR00762763 begin
#if ORIGINAL_VERSION
                MtkCameraParameters::FOCUS_MODE_AUTO,   
                ...
                MtkCameraParameters::FOCUS_MODE_INFINITY, 
#endif
// Gionee wutangzhi 2013-01-10 modify for CR00762763 end
            )
        ), 
        //......................................................................
